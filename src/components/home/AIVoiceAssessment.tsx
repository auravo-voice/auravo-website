...
const AIVoiceAssessment = () => {
  ...
  return (
    <section
      ref={ref}
      className="py-16 md:py-20 bg-neutral-950 relative overflow-hidden border-t border-neutral-800/50 fade-in-on-scroll"
    >
        ...
        >
          {features.map((feature, index) => (
            <motion.div key={index} variants={cardVariants as any} className="group relative">
              <div className="h-full relative border border-neutral-800/60 rounded-lg p-6 md:p-8 bg-neutral-900/40 backdrop-blur-sm transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neon-blue focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950 hover:border-neon-blue/50 hover:brightness-105">
                ...
                <div className="space-y-3 pt-2">
                  <h3 className="font-semibold text-xl md:text-2xl text-neutral-100 group-hover:text-neutral-50 transition-colors duration-300">
                    {feature.title}
                  </h3>
