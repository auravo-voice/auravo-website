export const WELCOME_SPEECH =
  "Welcome to Auravo. We'd like to spend about 5 minutes with you to understand your current strengths in your English language journey. Let's begin.";

export const QUESTIONS = {
  q1_city: "So tell me, which city do you live in?",
  q2_duration: "And for how long have you been living there?",
  q3_about_city:
    "Awesome! Would you like to speak 5 to 6 sentences about your city? Tell me what you love about it, what it's known for, anything at all.",
  midpoint:
    "Great job! We've done a fair amount of analysis already. Would you like to spend a couple more minutes for a fuller picture?",
  q4_objects:
    "Great! Can you name 5 things that are around you right now? For example, a desk, a window, a phone.",
